...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Creo il canvas grafico
        Canvas canvas = new Canvas("Mappa Lampadine", 800, 600);

        // Mantengo strutture parallele
        ...
        while (!exit) {
            ...
            System.out.println("3) Rimuovi lampadina");
            System.out.println("4) Cerca lampadina");
            System.out.println("5) Mostra sistema");
